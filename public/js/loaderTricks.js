...
let zoneTricks = document.getElementById('zoneTricks');
// let zoneLoader = document.getElementById('zoneLoader');
...
loader.addEventListener('click', function(event) {
    ...
    // .then(function(value) {
        // on recupere les donnee en json      
        // console.log(value.dataJsonCardTrickHtml);
        
        // let dataJsonCardTrickHtml = value.cardTrickHtml;
        // let dataJsonCardTrickHtml = value.dataJsonCardTrickHtml;
        
        // let dataJavascriptCardTrickHtml = JSON.stringify(dataJsonCardTrickHtml);

        // zoneTricks.innerHTML += dataJavascriptCardTrickHtml;
        // zoneTricks.innerHTML += dataJsonCardTrickHtml;

        // zoneLoader.innerHTML += dataJsonCardTrickHtml;
        // zoneLoader.innerHTML += dataJavascriptCardTrickHtml;
